...
export function buildBabelLoader({ mode }: BuildOptions) {
  ...
  return {
    ...
    use: {
      ...
      // опции можно вынести в отдельный файл babel.config.json, они автоматически подтянутся при сборке
      options: {
        presets: [
          ...
          [
            "@babel/preset-react",
            {
              runtime: isDev ? "automatic" : "automatic", // без данного свойства ассета сборка реакт в режиме devserver не запустится
            },
